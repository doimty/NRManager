...
- Full host suite 95/95; Python compile, source verifier, and `git diff --check` pass; local rootless compile/package smoke passed. Branch `fix/cc-serving-band-label`; corrected cloud build and device acceptance still required.

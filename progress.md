...
- Full host suite 97/97; Python compile, source verifier, and `git diff --check` pass. Branch `fix/cc-serving-band-label`; local/cloud build and device recovery acceptance are still required.

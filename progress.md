...
- Full host suite and source gates must be rerun after this compatibility change. Branch `fix/cc-serving-band-label`; corrected cloud build, updated SHA-bound prerm hotfix, and device acceptance still required.

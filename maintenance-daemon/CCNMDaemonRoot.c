...
//
//   <jbroot>/usr/libexec/nrmanager-maintenance -> <jbroot>
//   /var/jb/usr/libexec/nrmanager-maintenance  -> /var/jb
//   /usr/libexec/nrmanager-maintenance         -> "" (valid, bare paths)
//
// Suffix arithmetic, not a component search. A prefix that itself ended in
// "/usr/libexec/nrmanager-maintenance" would otherwise be cut at the first
